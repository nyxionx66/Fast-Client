package com.fastclient.event.server;

import com.fastclient.event.EventBus;
import com.fastclient.event.client.ReceivePacketEvent;
import com.fastclient.event.client.SendPacketEvent;
import com.fastclient.event.server.impl.AttackEntityEvent;
import com.fastclient.event.server.impl.DamageEntityEvent;
import com.fastclient.event.server.impl.GameJoinEvent;
import com.fastclient.event.server.impl.ReceiveChatEvent;
import com.fastclient.event.server.impl.SendChatEvent;
import com.fastclient.mixin.mixins.minecraft.network.packet.PlayerInteractEntityC2SPacketAccessor;
