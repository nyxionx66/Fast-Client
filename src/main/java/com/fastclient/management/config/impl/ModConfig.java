package com.fastclient.management.config.impl;
...
import com.fastclient.management.mod.api.AnchorPosition;
...
import com.fastclient.management.mod.settings.impl.ColorSetting;
...
public class ModConfig extends Config {
	...
	public void onLoad() {
		...
		ModManager modManager = Fast.getInstance().getModManager();
