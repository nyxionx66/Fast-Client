...
import com.fastclient.ui.component.impl.text.SearchBar;
import com.fastclient.utils.mouse.ScrollHelper;
...
public class Page extends SimplePage {
	...
	public Page(Gui parent, String title, String icon, GuiTransition transition) {
