...
import com.fastclient.management.music.ytdlp.Ytdlp;
...
public class MusicControlBar extends Component {
	...
	public void draw(double mouseX, double mouseY) {
		...
		Fast instance = Fast.getInstance();
		...
		urlField.setY(y + 12);
		downloadButton.setX(fieldCenterX + urlField.getWidth() + 8);
		downloadButton.setY(y + 12);
