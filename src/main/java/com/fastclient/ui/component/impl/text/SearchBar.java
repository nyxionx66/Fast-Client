package com.fastclient.ui.component.impl.text;
...
public class SearchBar extends Component {
	...
	public void draw(double mouseX, double mouseY) {
		...
		Skia.drawHeightCenteredText(Icon.SEARCH, x + 12, y + (height / 2), 
				isFocused() ? palette.getPrimary() : palette.getOnSurface(), Fonts.getIcon(24));
